...
public class TestSuite {
  ...
  @Test
  public void mosaicRainbowSunset() throws IOException {
    assertEquals(
            Utils.loadPicture("images/rainbowsunsetMosaic.png"),
            TestSuiteHelper.runMain(
                    tmpFolder, "mosaic", "images/rainbow64x64doc.png", "images/sunset64x32.png"));
  }
  @Test
  public void mosaicBWAndRainbow() throws IOException {
    assertEquals(
            Utils.loadPicture("images/rainbowpatternsmosaic64x64.png"),
            TestSuiteHelper.runMain(
                    tmpFolder, "mosaic", "images/rainbow64x64doc.png", "images/bwpatterns64x64.png"));
  }
  @Test
  public void mosaicBWRainbowGreen() throws IOException {
    assertEquals(
            Utils.loadPicture("images/rainbowpatternsgreenmosaic64x64.png"),
            TestSuiteHelper.runMain(
                    tmpFolder, "mosaic", "images/rainbow64x64doc.png", "images/bwpatterns64x64.png", "images/green64x64doc.png"));
  }
}